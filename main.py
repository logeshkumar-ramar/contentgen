...
from prompts import PROMPT_EMAIL, PROMPT_WHATSAPP, PROMPT_IMAGE, IMAGE_NEG_PROMPT, PROMPT_HOLIDAY, PROMPT_PLANNER, PROMPT_SMS, PROMPT_CARDS, PROMPT_BANNER, PROMPT_HOLIDAY2
